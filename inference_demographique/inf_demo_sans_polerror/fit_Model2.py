...
# Parameters are: (nu1F, nu2B, nu2F, m12, m21, TB, TE)
upper_bound = [100, 100, 100, 10, 10, 3, 3]
lower_bound = [1e-2, 1e-2, 1e-2, 0, 0, 0, 0]

# This is our initial guess for the parameters, which is somewhat arbitrary.
p0 = [2,0.1,2,1,1,0.2,0.2]
...
popt = [0.282821   ,  0.01       ,  0.267251   ,  7.75761    ,  3.99345    ,  0.0391814  ,  0.31603]
