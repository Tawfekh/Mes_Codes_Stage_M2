...
func = Model3.prior_onegrow_mig_ancestralfixed
...
# Parameters are: (nu1F, nu2B, nu2F, m, TE, e)
upper_bound = [100, 100, 100, 10, 3, 0.1]
lower_bound = [1e-2, 1e-2, 1e-2, 0, 0, 0]

# This is our initial guess for the parameters, which is somewhat arbitrary.
p0 = [2,0.1,2,1,0.2,0.001]
...
popt = [0.705166   ,  0.0961599  ,  0.952948   ,  1.17794    ,  1.35604    ,  0.0837048]
