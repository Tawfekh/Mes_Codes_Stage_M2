...
func = Model4.prior_onegrow_mig_ancestralfixed
...
# Parameters are: (nu1F, nu2B, nu2F, m12, m21, TE, e)
upper_bound = [100, 100, 100, 10, 10, 3, 0.1]
lower_bound = [1e-2, 1e-2, 1e-2, 0, 0, 0, 0]

# This is our initial guess for the parameters, which is somewhat arbitrary.
p0 = [2,0.1,2,1,1,0.2,0.001]
...
popt = [0.378645   ,  0.129237   ,  0.707047   ,  2.82081    ,  1.14616    ,  0.875648   ,  0.0719431]
