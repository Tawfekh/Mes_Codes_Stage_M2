...
upper_bound = [100, 100, 100, 10, 3, 3, 0.1]
lower_bound = [1e-2, 1e-2, 1e-2, 0, 0, 0, 0]

# This is our initial guess for the parameters, which is somewhat arbitrary.
p0 = [2,0.1,2,1,0.2,0.2,0.001]
...
popt = [0.446461   ,  0.0128741  ,  0.601727   ,  1.88124    ,  0.000201549,  1.42505    ,  0.0809581]
...
pylab.show()
# Save the figure
pylab.savefig('Model1_centre.png', dpi=50)

# Let's generate some data using ms, if you have it installed.
mscore = Model1.prior_onegrow_mig_mscore(popt)
