...
def prior_onegrow_mig_ancestralfixed((nu1F, nu2B, nu2F, m12, m21, TE, e), (n1,n2), pts):
    """
    Model with  split, exponential growth just after bottleneck in pop2, exp recovery, asymmetric migration rate

    nu1F: The final size for pop1
    nu2B: The bottleneck size for pop2
    nu2F: The final size for pop2
    TE: The the split and present
